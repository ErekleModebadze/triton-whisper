...
class TritonPythonModel:
    ...
    def __init__(self, device="cuda", model_name="openai/whisper-large-v3") -> None:
    ...
    def execute(self, requests):
        ...
        for request in requests:
            ...
            transcribed_text = self.transcriber_pipeline({"sampling_rate": sampling_rate, "raw": audio},
                                                         generate_kwargs={"language": "georgian"})["text"]
